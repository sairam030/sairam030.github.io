...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            root: ["projects", "personal-documents", "skills", "tools", "certifications", "interests"],
            skills: ["Big-Data-Engineering", "Apache-Spark", "Apache-Kafka", "Airflow", "Python", "Machine-Learning", "LLMs"],
            projects: ["Aviation-Analytics-Pipeline", "Placements-Agentic-RAG", "Healthcare-Management-System"],
            interests: ["Big Data Analytics", "Machine Learning", "Data Engineering", "LLMs", "Distributed Systems"],
            tools: ["Python", "R", "Docker", "Git", "MySQL", "PostgreSQL", "Hadoop"],
            certifications: ["AWS-Academy-Cloud-Foundations", "Generative-AI-with-LLMs", "Amazon-ML-Hackathon", "HuggingFace-Agents"],
        };
        this.state = {
            terminal: [],
        }
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">sairam@Ubuntu</div>
    ...
    handleCommands = (command, rowId) => {
        ...
        switch (main) {
            ...
            case "pwd":
                ...
                result = str.replace("~", "/home/sairam")
                break;
            case "code":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("vscode");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-sairam, todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
            ...
            case "about-sairam":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("about-sairam");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-sairam, todoist, trash, settings, sendmsg ]";
                }
                break;
